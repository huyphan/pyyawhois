...
#
#   spec/fixtures/responses/whois.iana.org/int/status_available
#
...
class TestWhoisIanaOrgIntStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.iana.org/int/status_available.txt"
        host         = "whois.iana.org"
