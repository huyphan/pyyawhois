...
#
#   spec/fixtures/responses/whois.nic.gl/status_registered
#
...
class TestWhoisNicGlStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.gl/status_registered.txt"
        host         = "whois.nic.gl"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.gl")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-03-11 03:00:00 UTC'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-12-02 19:11:52 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "Imp669-GL")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2015-01-01 03:00:00 UTC'))
