...
#
#   spec/fixtures/responses/whois.iis.nu/nu/status_registered
#
...
class TestWhoisIisNuNuStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.iis.nu/nu/status_registered.txt"
        host         = "whois.iis.nu"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.nu")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('1999-06-07'))
    ...
    def test_registrant_contacts(self):
        ...
        eq_(self.record.registrant_contacts[0].id, "mmr-142621")
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2014-05-06'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2015-06-07'))
