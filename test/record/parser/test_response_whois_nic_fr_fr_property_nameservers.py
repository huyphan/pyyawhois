...
#
#   spec/fixtures/responses/whois.nic.fr/fr/property_nameservers
#
...
class TestWhoisNicFrFrPropertyNameservers(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/fr/property_nameservers.txt"
        host         = "whois.nic.fr"
