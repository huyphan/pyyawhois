...
#
#   spec/fixtures/responses/whois.domain.kg/status_registered
#
...
class TestWhoisDomainKgStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.domain.kg/status_registered.txt"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2004-02-10 09:42:42'))

    def test_updated_on(self):
        eq_(self.record.updated_on.__class__.__name__, 'datetime')
        eq_(self.record.updated_on, time_parse('2010-04-19 21:47:14'))

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2014-03-30 23:59:00'))
