...
#
#   spec/fixtures/responses/whois.1und1.info/status_available
#
...
class TestWhois1und1InfoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.1und1.info/status_available.txt"
