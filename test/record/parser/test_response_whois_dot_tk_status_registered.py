...
#
#   spec/fixtures/responses/whois.dot.tk/status_registered
#
...
class TestWhoisDotTkStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dot.tk/status_registered.txt"
        host         = "whois.dot.tk"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2001-12-18 00:00:00'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2012-03-02 00:00:00'))
