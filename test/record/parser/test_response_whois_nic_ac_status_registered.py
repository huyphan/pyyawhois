...
#
#   spec/fixtures/responses/whois.nic.ac/status_registered
#
...
class TestWhoisNicAcStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ac/status_registered.txt"
        host         = "whois.nic.ac"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.ac")
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-04-03'))
