...
#
#   spec/fixtures/responses/whois.kenic.or.ke/status_available
#
...
class TestWhoisKenicOrKeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.kenic.or.ke/status_available.txt"
