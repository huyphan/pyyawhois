...
#
#   spec/fixtures/responses/whois.tznic.or.tz/status_available
#
...
class TestWhoisTznicOrTzStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tznic.or.tz/status_available.txt"
