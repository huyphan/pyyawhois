...
#
#   spec/fixtures/responses/whois.nic.st/status_available
#
...
class TestWhoisNicStStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.st/status_available.txt"
        host         = "whois.nic.st"
