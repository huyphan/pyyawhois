...
#
#   spec/fixtures/responses/whois.nic.li/status_available
#
...
class TestWhoisNicLiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.li/status_available.txt"
        host         = "whois.nic.li"
