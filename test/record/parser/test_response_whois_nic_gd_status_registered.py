...
#
#   spec/fixtures/responses/whois.nic.gd/status_registered
#
...
class TestWhoisNicGdStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.gd/status_registered.txt"
        host         = "whois.nic.gd"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.gd")
    ...
    def test_admin_contacts(self):
        ...
        eq_(self.record.admin_contacts[0].id, "P-GXI35")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2006-12-11 00:00:00'))
    ...
    def test_registrant_contacts(self):
        ...
        eq_(self.record.registrant_contacts[0].id, "P-GXI35")
    ...
    def test_technical_contacts(self):
        ...
        eq_(self.record.technical_contacts[0].id, "P-GXI35")
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-11-12 16:07:05'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-12-11 00:00:00'))
