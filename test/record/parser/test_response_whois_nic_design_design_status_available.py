...
#
#   spec/fixtures/responses/whois.nic.design/design/status_available
#
...
class TestWhoisNicDesignDesignStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.design/design/status_available.txt"
