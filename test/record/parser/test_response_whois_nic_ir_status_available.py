...
#
#   spec/fixtures/responses/whois.nic.ir/status_available
#
...
class TestWhoisNicIrStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ir/status_available.txt"
        host         = "whois.nic.ir"
