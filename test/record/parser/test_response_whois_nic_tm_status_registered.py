...
#
#   spec/fixtures/responses/whois.nic.tm/status_registered
#
...
class TestWhoisNicTmStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.tm/status_registered.txt"
        host         = "whois.nic.tm"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.tm")
