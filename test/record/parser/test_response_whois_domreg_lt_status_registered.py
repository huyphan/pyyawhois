...
#
#   spec/fixtures/responses/whois.domreg.lt/status_registered
#
...
class TestWhoisDomregLtStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.domreg.lt/status_registered.txt"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('1999-06-06'))
