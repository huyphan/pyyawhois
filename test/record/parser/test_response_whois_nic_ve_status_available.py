...
#
#   spec/fixtures/responses/whois.nic.ve/status_available
#
...
class TestWhoisNicVeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ve/status_available.txt"
        host         = "whois.nic.ve"
