...
#
#   spec/fixtures/responses/whois.denic.de/status_available
#
...
class TestWhoisDenicDeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.denic.de/status_available.txt"
        host         = "whois.denic.de"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.de")
