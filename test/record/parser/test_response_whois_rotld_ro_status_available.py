...
#
#   spec/fixtures/responses/whois.rotld.ro/status_available
#
...
class TestWhoisRotldRoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.rotld.ro/status_available.txt"
        host         = "whois.rotld.ro"
