...
#
#   spec/fixtures/responses/whois.nic.nf/status_registered
#
...
class TestWhoisNicNfStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.nf/status_registered.txt"
        host         = "whois.nic.nf"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.nf")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2005-11-27 11:00:00 UTC'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-12-06 07:35:49 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "26552-CoCCA")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2014-11-27 11:00:00 UTC'))
