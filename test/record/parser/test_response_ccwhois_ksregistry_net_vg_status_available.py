...
#
#   spec/fixtures/responses/ccwhois.ksregistry.net/vg/status_available
#
...
class TestCcwhoisKsregistryNetVgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/ccwhois.ksregistry.net/vg/status_available.txt"
