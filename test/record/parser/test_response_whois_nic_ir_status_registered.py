...
#
#   spec/fixtures/responses/whois.nic.ir/status_registered
#
...
class TestWhoisNicIrStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ir/status_registered.txt"
        host         = "whois.nic.ir"
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2014-02-17'))
