...
#
#   spec/fixtures/responses/whois.gov.za/status_registered
#
...
class TestWhoisGovZaStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.gov.za/status_registered.txt"
        host         = "whois.gov.za"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2012-09-03'))
