...
#
#   spec/fixtures/responses/whois.centralnic.com/uk.net/status_available
#
...
class TestWhoisCentralnicComUkNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.centralnic.com/uk.net/status_available.txt"
