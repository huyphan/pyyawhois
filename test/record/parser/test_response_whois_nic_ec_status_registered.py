...
#
#   spec/fixtures/responses/whois.nic.ec/status_registered
#
...
class TestWhoisNicEcStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ec/status_registered.txt"
        host         = "whois.nic.ec"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.ec")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-10-16 00:00:00'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-09-17 00:00:00'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-10-16 00:00:00'))
