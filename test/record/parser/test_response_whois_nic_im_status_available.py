...
#
#   spec/fixtures/responses/whois.nic.im/status_available
#
...
class TestWhoisNicImStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.im/status_available.txt"
        host         = "whois.nic.im"
