...
#
#   spec/fixtures/responses/whois.sgnic.sg/property_nameservers_schema_1
#
...
class TestWhoisSgnicSgPropertyNameserversSchema1(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.sgnic.sg/property_nameservers_schema_1.txt"
        host         = "whois.sgnic.sg"
