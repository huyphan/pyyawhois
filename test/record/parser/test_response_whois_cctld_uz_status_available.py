...
#
#   spec/fixtures/responses/whois.cctld.uz/status_available
#
...
class TestWhoisCctldUzStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.cctld.uz/status_available.txt"
        host         = "whois.cctld.uz"
