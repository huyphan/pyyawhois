...
#
#   spec/fixtures/responses/whois.registro.br/status_available
#
...
class TestWhoisRegistroBrStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registro.br/status_available.txt"
