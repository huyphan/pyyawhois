...
#
#   spec/fixtures/responses/whois.sk-nic.sk/status_available
#
...
class TestWhoisSkNicSkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.sk-nic.sk/status_available.txt"
