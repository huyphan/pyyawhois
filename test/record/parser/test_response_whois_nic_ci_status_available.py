...
#
#   spec/fixtures/responses/whois.nic.ci/status_available
#
...
class TestWhoisNicCiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ci/status_available.txt"
        host         = "whois.nic.ci"
