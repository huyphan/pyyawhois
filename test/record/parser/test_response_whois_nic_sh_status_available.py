...
#
#   spec/fixtures/responses/whois.nic.sh/status_available
#
...
class TestWhoisNicShStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.sh/status_available.txt"
        host         = "whois.nic.sh"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.sh")
