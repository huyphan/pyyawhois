...
#
#   spec/fixtures/responses/whois.nic.ht/status_registered
#
...
class TestWhoisNicHtStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ht/status_registered.txt"
        host         = "whois.nic.ht"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.ht")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2004-06-17 23:00:00 UTC'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-05-16 09:18:24 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "112029-CoCCA")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2014-06-17 23:00:00 UTC'))
