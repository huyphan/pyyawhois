...
#
#   spec/fixtures/responses/whois.pir.org/status_available
#
...
class TestWhoisPirOrgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.pir.org/status_available.txt"
        host         = "whois.pir.org"
