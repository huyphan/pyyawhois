...
#
#   spec/fixtures/responses/whois.nic.cl/status_registered
#
...
class TestWhoisNicClStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.cl/status_registered.txt"
        host         = "whois.nic.cl"
