...
#
#   spec/fixtures/responses/whois.eu/status_available
#
...
class TestWhoisEuStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.eu/status_available.txt"
        host         = "whois.eu"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.eu")
