...
#
#   spec/fixtures/responses/whois.gg/status_available
#
...
class TestWhoisGgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.gg/status_available.txt"
        host         = "whois.gg"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.gg")
