...
#
#   spec/fixtures/responses/whois.nic.fr/tf/status_registered
#
...
class TestWhoisNicFrTfStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/tf/status_registered.txt"
        host         = "whois.nic.fr"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2004-10-26'))
    ...
    def test_registrant_contacts(self):
        ...
        eq_(self.record.registrant_contacts[0].id, "AAEA9-FRNIC")
        eq_(self.record.registrant_contacts[0].name, None)
        eq_(self.record.registrant_contacts[0].organization, "Afnic (Terres Australes et Antarctiques - TOM)")
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2004-10-29'))
