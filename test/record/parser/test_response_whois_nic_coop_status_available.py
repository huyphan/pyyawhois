...
#
#   spec/fixtures/responses/whois.nic.coop/status_available
#
...
class TestWhoisNicCoopStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.coop/status_available.txt"
        host         = "whois.nic.coop"
