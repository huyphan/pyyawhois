...
#
#   spec/fixtures/responses/whois.registrypro.pro/status_available
#
...
class TestWhoisRegistryproProStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registrypro.pro/status_available.txt"
