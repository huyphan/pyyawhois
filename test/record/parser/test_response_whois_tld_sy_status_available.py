...
#
#   spec/fixtures/responses/whois.tld.sy/status_available
#
...
class TestWhoisTldSyStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tld.sy/status_available.txt"
        host         = "whois.tld.sy"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.sy")
