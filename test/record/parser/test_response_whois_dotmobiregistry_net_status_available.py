...
#
#   spec/fixtures/responses/whois.dotmobiregistry.net/status_available
#
...
class TestWhoisDotmobiregistryNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dotmobiregistry.net/status_available.txt"
