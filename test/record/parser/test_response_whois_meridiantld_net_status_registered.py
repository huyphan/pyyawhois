...
#
#   spec/fixtures/responses/whois.meridiantld.net/status_registered
#
...
class TestWhoisMeridiantldNetStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.meridiantld.net/status_registered.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.tc")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2006-10-11 21:00:00 UTC'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-10-12 21:00:00 UTC'))
