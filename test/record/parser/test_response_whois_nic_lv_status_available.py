...
#
#   spec/fixtures/responses/whois.nic.lv/status_available
#
...
class TestWhoisNicLvStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.lv/status_available.txt"
        host         = "whois.nic.lv"
