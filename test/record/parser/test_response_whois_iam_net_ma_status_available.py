...
#
#   spec/fixtures/responses/whois.iam.net.ma/status_available
#
...
class TestWhoisIamNetMaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.iam.net.ma/status_available.txt"
