...
#
#   spec/fixtures/responses/whois.nic.hu/status_registered
#
...
class TestWhoisNicHuStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.hu/status_registered.txt"
        host         = "whois.nic.hu"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.hu")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2000-03-25 23:20:39'))
