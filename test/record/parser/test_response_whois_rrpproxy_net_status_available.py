...
#
#   spec/fixtures/responses/whois.rrpproxy.net/status_available
#
...
class TestWhoisRrpproxyNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.rrpproxy.net/status_available.txt"
