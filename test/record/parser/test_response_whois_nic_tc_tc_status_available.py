...
#
#   spec/fixtures/responses/whois.nic.tc/tc/status_available
#
...
class TestWhoisNicTcTcStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.tc/tc/status_available.txt"
        host         = "whois.nic.tc"
