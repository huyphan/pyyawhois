...
#
#   spec/fixtures/responses/whois.nic.gov/status_available
#
...
class TestWhoisNicGovStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.gov/status_available.txt"
        host         = "whois.nic.gov"
