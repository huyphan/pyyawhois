...
#
#   spec/fixtures/responses/whois.nic.asia/status_reserved
#
...
class TestWhoisNicAsiaStatusReserved(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.asia/status_reserved.txt"
        host         = "whois.nic.asia"
