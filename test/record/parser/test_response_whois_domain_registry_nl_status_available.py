...
#
#   spec/fixtures/responses/whois.domain-registry.nl/status_available
#
...
class TestWhoisDomainRegistryNlStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.domain-registry.nl/status_available.txt"
