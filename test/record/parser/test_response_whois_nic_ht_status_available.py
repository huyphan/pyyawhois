...
#
#   spec/fixtures/responses/whois.nic.ht/status_available
#
...
class TestWhoisNicHtStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ht/status_available.txt"
        host         = "whois.nic.ht"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ht")
