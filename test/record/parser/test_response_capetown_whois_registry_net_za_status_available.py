...
#
#   spec/fixtures/responses/capetown-whois.registry.net.za/status_available
#
...
class TestCapetownWhoisRegistryNetZaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/capetown-whois.registry.net.za/status_available.txt"
