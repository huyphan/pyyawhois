...
#
#   spec/fixtures/responses/whois.pandi.or.id/status_available
#
...
class TestWhoisPandiOrIdStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.pandi.or.id/status_available.txt"
