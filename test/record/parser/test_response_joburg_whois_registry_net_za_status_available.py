...
#
#   spec/fixtures/responses/joburg-whois.registry.net.za/status_available
#
...
class TestJoburgWhoisRegistryNetZaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/joburg-whois.registry.net.za/status_available.txt"
