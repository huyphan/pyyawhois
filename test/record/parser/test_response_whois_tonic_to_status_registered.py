...
#
#   spec/fixtures/responses/whois.tonic.to/status_registered
#
...
class TestWhoisTonicToStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tonic.to/status_registered.txt"
        host         = "whois.tonic.to"
