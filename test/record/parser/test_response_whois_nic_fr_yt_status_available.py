...
#
#   spec/fixtures/responses/whois.nic.fr/yt/status_available
#
...
class TestWhoisNicFrYtStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/yt/status_available.txt"
        host         = "whois.nic.fr"
