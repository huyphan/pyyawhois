...
#
#   spec/fixtures/responses/whois.usp.ac.fj/status_registered
#
...
class TestWhoisUspAcFjStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.usp.ac.fj/status_registered.txt"
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-04-28'))
