...
#
#   spec/fixtures/responses/whois.nic.mx/status_available
#
...
class TestWhoisNicMxStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.mx/status_available.txt"
        host         = "whois.nic.mx"
