...
#
#   spec/fixtures/responses/whois.nic.kz/status_available
#
...
class TestWhoisNicKzStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.kz/status_available.txt"
        host         = "whois.nic.kz"
