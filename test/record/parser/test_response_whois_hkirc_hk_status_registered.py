...
#
#   spec/fixtures/responses/whois.hkirc.hk/status_registered
#
...
class TestWhoisHkircHkStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.hkirc.hk/status_registered.txt"
        host         = "whois.hkirc.hk"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2004-04-06'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-03-31'))
