...
#
#   spec/fixtures/responses/whois.co.ca/status_available
#
...
class TestWhoisCoCaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.co.ca/status_available.txt"
        host         = "whois.co.ca"
