...
#
#   spec/fixtures/responses/whois.cat/status_available
#
...
class TestWhoisCatStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.cat/status_available.txt"
        host         = "whois.cat"
