...
#
#   spec/fixtures/responses/jobswhois.verisign-grs.com/jobs/status_available
#
...
class TestJobswhoisVerisignGrsComJobsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/jobswhois.verisign-grs.com/jobs/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.jobs")
