...
#
#   spec/fixtures/responses/whois.afilias-grs.info/vc/status_registered
#
...
class TestWhoisAfiliasGrsInfoVcStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.afilias-grs.info/vc/status_registered.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.vc")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2005-06-29 00:58:18 UTC'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2009-02-17 17:43:40 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "D133753-LRCC")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2011-06-29 00:58:18 UTC'))
