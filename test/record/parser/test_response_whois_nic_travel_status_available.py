...
#
#   spec/fixtures/responses/whois.nic.travel/status_available
#
...
class TestWhoisNicTravelStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.travel/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.travel")
