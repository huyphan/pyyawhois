...
#
#   spec/fixtures/responses/whois.nic.sl/status_available
#
...
class TestWhoisNicSlStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.sl/status_available.txt"
        host         = "whois.nic.sl"
