...
#
#   spec/fixtures/responses/whois.domainregistry.my/status_available
#
...
class TestWhoisDomainregistryMyStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.domainregistry.my/status_available.txt"
