...
#
#   spec/fixtures/responses/whois.verisign-grs.com/net/status_available
#
...
class TestWhoisVerisignGrsComNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.verisign-grs.com/net/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.net")
