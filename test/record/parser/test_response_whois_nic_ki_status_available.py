...
#
#   spec/fixtures/responses/whois.nic.ki/status_available
#
...
class TestWhoisNicKiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ki/status_available.txt"
        host         = "whois.nic.ki"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ki")
