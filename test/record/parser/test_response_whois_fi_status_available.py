...
#
#   spec/fixtures/responses/whois.fi/status_available
#
...
class TestWhoisFiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.fi/status_available.txt"
        host         = "whois.fi"
