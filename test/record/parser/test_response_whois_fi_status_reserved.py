...
#
#   spec/fixtures/responses/whois.fi/status_reserved
#
...
class TestWhoisFiStatusReserved(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.fi/status_reserved.txt"
        host         = "whois.fi"
