...
#
#   spec/fixtures/responses/whois.tcinet.ru/xn--p1ai/status_registered
#
...
class TestWhoisTcinetRuXnP1aiStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tcinet.ru/xn--p1ai/status_registered.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "xn----8sbc3ahklcs4adf.xn--p1ai")

    def test_nameservers(self):
        eq_(self.record.nameservers.__class__.__name__, 'list')
        eq_(len(self.record.nameservers), 3)
        eq_(self.record.nameservers[0].__class__.__name__, 'Nameserver')
        eq_(self.record.nameservers[0].name, "ns1.redsoft.ru")
        eq_(self.record.nameservers[1].__class__.__name__, 'Nameserver')
        eq_(self.record.nameservers[1].name, "ns2.redsoft.ru")
        eq_(self.record.nameservers[2].__class__.__name__, 'Nameserver')
        eq_(self.record.nameservers[2].name, "ns2.r01.ru")
    ...
    def test_admin_contacts(self):
        ...
        eq_(self.record.admin_contacts[0].name, "R01 Personal Data Operator protected")
        eq_(self.record.admin_contacts[0].organization, None)
        eq_(self.record.admin_contacts[0].phone, "+7 800 3020800")
        eq_(self.record.admin_contacts[0].fax, None)
        eq_(self.record.admin_contacts[0].email, "liderkubani@gmail.com")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2010-11-12'))

    def test_registrar(self):
        eq_(self.record.registrar.__class__.__name__, 'Registrar')
        eq_(self.record.registrar.id, "R01-REG-RF")
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2011-11-12'))
