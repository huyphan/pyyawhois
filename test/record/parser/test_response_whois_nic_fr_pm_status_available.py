...
#
#   spec/fixtures/responses/whois.nic.fr/pm/status_available
#
...
class TestWhoisNicFrPmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/pm/status_available.txt"
        host         = "whois.nic.fr"
