...
#
#   spec/fixtures/responses/whois.networksolutions.com/status_available
#
...
class TestWhoisNetworksolutionsComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.networksolutions.com/status_available.txt"
