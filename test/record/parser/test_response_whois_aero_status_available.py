...
#
#   spec/fixtures/responses/whois.aero/status_available
#
...
class TestWhoisAeroStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.aero/status_available.txt"
        host         = "whois.aero"
