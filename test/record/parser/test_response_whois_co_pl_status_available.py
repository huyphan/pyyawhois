...
#
#   spec/fixtures/responses/whois.co.pl/status_available
#
...
class TestWhoisCoPlStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.co.pl/status_available.txt"
        host         = "whois.co.pl"
