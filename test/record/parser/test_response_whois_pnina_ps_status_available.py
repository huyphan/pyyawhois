...
#
#   spec/fixtures/responses/whois.pnina.ps/status_available
#
...
class TestWhoisPninaPsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.pnina.ps/status_available.txt"
        host         = "whois.pnina.ps"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ps")
