...
#
#   spec/fixtures/responses/whois.nic.li/status_registered
#
...
class TestWhoisNicLiStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.li/status_registered.txt"
        host         = "whois.nic.li"
