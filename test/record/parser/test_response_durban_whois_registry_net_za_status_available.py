...
#
#   spec/fixtures/responses/durban-whois.registry.net.za/status_available
#
...
class TestDurbanWhoisRegistryNetZaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/durban-whois.registry.net.za/status_available.txt"
