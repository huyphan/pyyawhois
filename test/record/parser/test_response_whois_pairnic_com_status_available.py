...
#
#   spec/fixtures/responses/whois.pairnic.com/status_available
#
...
class TestWhoisPairnicComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.pairnic.com/status_available.txt"
