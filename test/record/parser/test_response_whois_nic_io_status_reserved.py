...
#
#   spec/fixtures/responses/whois.nic.io/status_reserved
#
...
class TestWhoisNicIoStatusReserved(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.io/status_reserved.txt"
        host         = "whois.nic.io"
