...
#
#   spec/fixtures/responses/kero.yachay.pe/status_suspended
#
...
class TestKeroYachayPeStatusSuspended(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/kero.yachay.pe/status_suspended.txt"
        host         = "kero.yachay.pe"
