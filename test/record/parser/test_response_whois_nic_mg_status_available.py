...
#
#   spec/fixtures/responses/whois.nic.mg/status_available
#
...
class TestWhoisNicMgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.mg/status_available.txt"
        host         = "whois.nic.mg"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.mg")
