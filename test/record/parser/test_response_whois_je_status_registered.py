...
#
#   spec/fixtures/responses/whois.je/status_registered
#
...
class TestWhoisJeStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.je/status_registered.txt"
        host         = "whois.je"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.je")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2002-10-31 00:00:00 UTC'))
