...
#
#   spec/fixtures/responses/whois.cnnic.cn/status_registered
#
...
class TestWhoisCnnicCnStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.cnnic.cn/status_registered.txt"
        host         = "whois.cnnic.cn"
        part         = yawhois.record.Part(open(fixture_path, "r").read(), host)
        self.record  = yawhois.record.Record(None, [part])

    def test_status(self):
        eq_(self.record.status, ["clientDeleteProhibited", "serverDeleteProhibited", "clientUpdateProhibited", "serverUpdateProhibited", "clientTransferProhibited", "serverTransferProhibited"])

    def test_available(self):
        eq_(self.record.available, False)

    def test_domain(self):
        eq_(self.record.domain, "google.cn")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-03-17 12:20:05'))

    def test_registrar(self):
        eq_(self.record.registrar.__class__.__name__, 'Registrar')
        eq_(self.record.registrar.id, "MarkMonitor Inc.")
    ...
    def test_registrant_contacts(self):
        ...
        eq_(self.record.registrant_contacts[0].id, "cnnic-zdmd-022")
    ...
    def test_domain_id(self):
        eq_(self.record.domain_id, "20030311s10001s00033735-cn")
