...
#
#   spec/fixtures/responses/whois.rnids.rs/status_available
#
...
class TestWhoisRnidsRsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.rnids.rs/status_available.txt"
        host         = "whois.rnids.rs"
