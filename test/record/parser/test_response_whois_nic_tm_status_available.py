...
#
#   spec/fixtures/responses/whois.nic.tm/status_available
#
...
class TestWhoisNicTmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.tm/status_available.txt"
        host         = "whois.nic.tm"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.tm")
