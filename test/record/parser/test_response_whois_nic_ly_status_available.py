...
#
#   spec/fixtures/responses/whois.nic.ly/status_available
#
...
class TestWhoisNicLyStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ly/status_available.txt"
        host         = "whois.nic.ly"
