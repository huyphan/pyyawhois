...
#
#   spec/fixtures/responses/whois.donuts.co/bike/status_available
#
...
class TestWhoisDonutsCoBikeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.donuts.co/bike/status_available.txt"
