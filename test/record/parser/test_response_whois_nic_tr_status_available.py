...
#
#   spec/fixtures/responses/whois.nic.tr/status_available
#
...
class TestWhoisNicTrStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.tr/status_available.txt"
        host         = "whois.nic.tr"
