...
#
#   spec/fixtures/responses/whois.gandi.net/status_available
#
...
class TestWhoisGandiNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.gandi.net/status_available.txt"
