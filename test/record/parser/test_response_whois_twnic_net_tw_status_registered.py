...
#
#   spec/fixtures/responses/whois.twnic.net.tw/status_registered
#
...
class TestWhoisTwnicNetTwStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.twnic.net.tw/status_registered.txt"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2000-08-29'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2011-11-09'))
