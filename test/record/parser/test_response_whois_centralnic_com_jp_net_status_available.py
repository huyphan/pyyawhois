...
#
#   spec/fixtures/responses/whois.centralnic.com/jp.net/status_available
#
...
class TestWhoisCentralnicComJpNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.centralnic.com/jp.net/status_available.txt"
