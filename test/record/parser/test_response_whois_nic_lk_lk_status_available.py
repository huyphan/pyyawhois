...
#
#   spec/fixtures/responses/whois.nic.lk/lk/status_available
#
...
class TestWhoisNicLkLkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.lk/lk/status_available.txt"
        host         = "whois.nic.lk"
