...
#
#   spec/fixtures/responses/whois.cctld.by/status_available
#
...
class TestWhoisCctldByStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.cctld.by/status_available.txt"
        host         = "whois.cctld.by"
