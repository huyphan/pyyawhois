...
#
#   spec/fixtures/responses/whois.je/status_available
#
...
class TestWhoisJeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.je/status_available.txt"
        host         = "whois.je"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.je")
