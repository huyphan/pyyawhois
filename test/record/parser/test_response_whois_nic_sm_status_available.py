...
#
#   spec/fixtures/responses/whois.nic.sm/status_available
#
...
class TestWhoisNicSmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.sm/status_available.txt"
        host         = "whois.nic.sm"
