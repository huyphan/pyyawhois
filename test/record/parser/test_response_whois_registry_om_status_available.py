...
#
#   spec/fixtures/responses/whois.registry.om/status_available
#
...
class TestWhoisRegistryOmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registry.om/status_available.txt"
