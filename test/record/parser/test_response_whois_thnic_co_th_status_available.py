...
#
#   spec/fixtures/responses/whois.thnic.co.th/status_available
#
...
class TestWhoisThnicCoThStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.thnic.co.th/status_available.txt"
