...
#
#   spec/fixtures/responses/whois.nic.sm/status_registered
#
...
class TestWhoisNicSmStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.sm/status_registered.txt"
        host         = "whois.nic.sm"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-04-03 00:00:00 UTC'))

    def test_updated_on(self):
        eq_(self.record.updated_on.__class__.__name__, 'datetime')
        eq_(self.record.updated_on, time_parse('2008-08-01 00:00:00 UTC'))
