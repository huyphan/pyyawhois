...
#
#   spec/fixtures/responses/whois.nic.mu/status_available
#
...
class TestWhoisNicMuStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.mu/status_available.txt"
        host         = "whois.nic.mu"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.mu")
