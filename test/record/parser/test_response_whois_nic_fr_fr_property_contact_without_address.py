...
#
#   spec/fixtures/responses/whois.nic.fr/fr/property_contact_without_address
#
...
class TestWhoisNicFrFrPropertyContactWithoutAddress(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/fr/property_contact_without_address.txt"
        host         = "whois.nic.fr"
