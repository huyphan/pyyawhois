...
#
#   spec/fixtures/responses/whois.ai/status_available
#
...
class TestWhoisAiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.ai/status_available.txt"
        host         = "whois.ai"
