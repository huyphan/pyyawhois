...
#
#   spec/fixtures/responses/whois.corporatedomains.com/status_available
#
...
class TestWhoisCorporatedomainsComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.corporatedomains.com/status_available.txt"
