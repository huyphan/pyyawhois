...
#
#   spec/fixtures/responses/whois.audns.net.au/status_available
#
...
class TestWhoisAudnsNetAuStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.audns.net.au/status_available.txt"
