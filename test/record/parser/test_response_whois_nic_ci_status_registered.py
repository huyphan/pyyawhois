...
#
#   spec/fixtures/responses/whois.nic.ci/status_registered
#
...
class TestWhoisNicCiStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ci/status_registered.txt"
        host         = "whois.nic.ci"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2006-01-27 11:14:47.77'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-02-14 11:14:47.77'))
