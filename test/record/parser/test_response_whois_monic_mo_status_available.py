...
#
#   spec/fixtures/responses/whois.monic.mo/status_available
#
...
class TestWhoisMonicMoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.monic.mo/status_available.txt"
        host         = "whois.monic.mo"
