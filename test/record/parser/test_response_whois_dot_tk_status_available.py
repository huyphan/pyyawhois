...
#
#   spec/fixtures/responses/whois.dot.tk/status_available
#
...
class TestWhoisDotTkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dot.tk/status_available.txt"
        host         = "whois.dot.tk"
