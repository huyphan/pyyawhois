...
#
#   spec/fixtures/responses/whois.nic.gs/status_available
#
...
class TestWhoisNicGsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.gs/status_available.txt"
        host         = "whois.nic.gs"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.gs")
