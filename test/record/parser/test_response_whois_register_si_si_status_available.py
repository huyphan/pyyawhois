...
#
#   spec/fixtures/responses/whois.register.si/si/status_available
#
...
class TestWhoisRegisterSiSiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.register.si/si/status_available.txt"
