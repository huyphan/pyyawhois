...
#
#   spec/fixtures/responses/whois.netcom.cm/status_available
#
...
class TestWhoisNetcomCmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.netcom.cm/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.cm")
