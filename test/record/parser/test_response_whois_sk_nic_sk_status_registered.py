...
#
#   spec/fixtures/responses/whois.sk-nic.sk/status_registered
#
...
class TestWhoisSkNicSkStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.sk-nic.sk/status_registered.txt"
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2010-06-28'))

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2011-07-23'))
