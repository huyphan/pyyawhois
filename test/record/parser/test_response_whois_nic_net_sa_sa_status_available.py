...
#
#   spec/fixtures/responses/whois.nic.net.sa/sa/status_available
#
...
class TestWhoisNicNetSaSaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.net.sa/sa/status_available.txt"
