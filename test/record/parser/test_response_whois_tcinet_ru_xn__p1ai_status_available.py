...
#
#   spec/fixtures/responses/whois.tcinet.ru/xn--p1ai/status_available
#
...
class TestWhoisTcinetRuXnP1aiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tcinet.ru/xn--p1ai/status_available.txt"
