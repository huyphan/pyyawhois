...
#
#   spec/fixtures/responses/whois.in.ua/status_available
#
...
class TestWhoisInUaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.in.ua/status_available.txt"
        host         = "whois.in.ua"
