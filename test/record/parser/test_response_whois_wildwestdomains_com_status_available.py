...
#
#   spec/fixtures/responses/whois.wildwestdomains.com/status_available
#
...
class TestWhoisWildwestdomainsComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.wildwestdomains.com/status_available.txt"
