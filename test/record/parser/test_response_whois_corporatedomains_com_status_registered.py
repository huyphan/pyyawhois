...
#
#   spec/fixtures/responses/whois.corporatedomains.com/status_registered
#
...
class TestWhoisCorporatedomainsComStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.corporatedomains.com/status_registered.txt"
        host         = "whois.corporatedomains.com"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('1992-11-24 00:00:00 -0500'))

    def test_registrar(self):
        eq_(self.record.registrar.__class__.__name__, 'Registrar')
        eq_(self.record.registrar.id, "299")
        eq_(self.record.registrar.name, "CORPORATE DOMAINS, INC.")
        eq_(self.record.registrar.organization, "CORPORATE DOMAINS, INC.")
        eq_(self.record.registrar.url, "www.cscprotectsbrands.com")
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2013-11-23 00:00:00 -0500'))
