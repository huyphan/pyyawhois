...
#
#   spec/fixtures/responses/whois.nic.fr/pm/status_registered
#
...
class TestWhoisNicFrPmStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/pm/status_registered.txt"
        host         = "whois.nic.fr"
    ...
    def test_registrant_contacts(self):
        ...
        eq_(self.record.registrant_contacts[0].id, "APEM2-FRNIC")
        eq_(self.record.registrant_contacts[0].name, None)
        eq_(self.record.registrant_contacts[0].organization, "Afnic (Saint-Pierre et Miquelon - CTOM)")
