...
#
#   spec/fixtures/responses/whois.nic.priv.at/status_available
#
...
class TestWhoisNicPrivAtStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.priv.at/status_available.txt"
