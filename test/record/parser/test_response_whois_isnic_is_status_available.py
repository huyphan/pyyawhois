...
#
#   spec/fixtures/responses/whois.isnic.is/status_available
#
...
class TestWhoisIsnicIsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.isnic.is/status_available.txt"
        host         = "whois.isnic.is"
