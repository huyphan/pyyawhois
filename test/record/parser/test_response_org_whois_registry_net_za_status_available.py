...
#
#   spec/fixtures/responses/org-whois.registry.net.za/status_available
#
...
class TestOrgWhoisRegistryNetZaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/org-whois.registry.net.za/status_available.txt"
