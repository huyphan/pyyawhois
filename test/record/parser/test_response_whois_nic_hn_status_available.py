...
#
#   spec/fixtures/responses/whois.nic.hn/status_available
#
...
class TestWhoisNicHnStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.hn/status_available.txt"
        host         = "whois.nic.hn"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.hn")
