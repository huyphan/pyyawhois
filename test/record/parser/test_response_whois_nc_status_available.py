...
#
#   spec/fixtures/responses/whois.nc/status_available
#
...
class TestWhoisNcStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nc/status_available.txt"
        host         = "whois.nc"
