...
#
#   spec/fixtures/responses/whois.aeda.net.ae/status_available
#
...
class TestWhoisAedaNetAeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.aeda.net.ae/status_available.txt"
