...
#
#   spec/fixtures/responses/whois.cira.ca/status_available
#
...
class TestWhoisCiraCaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.cira.ca/status_available.txt"
        host         = "whois.cira.ca"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ca")
