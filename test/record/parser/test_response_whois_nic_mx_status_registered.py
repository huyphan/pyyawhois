...
#
#   spec/fixtures/responses/whois.nic.mx/status_registered
#
...
class TestWhoisNicMxStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.mx/status_registered.txt"
        host         = "whois.nic.mx"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2009-05-12'))

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2016-05-11'))
