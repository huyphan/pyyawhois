...
#
#   spec/fixtures/responses/whois.markmonitor.com/status_available
#
...
class TestWhoisMarkmonitorComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.markmonitor.com/status_available.txt"
