...
#
#   spec/fixtures/responses/whois.usp.ac.fj/status_available
#
...
class TestWhoisUspAcFjStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.usp.ac.fj/status_available.txt"
