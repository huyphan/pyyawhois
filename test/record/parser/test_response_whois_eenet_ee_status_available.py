...
#
#   spec/fixtures/responses/whois.eenet.ee/status_available
#
...
class TestWhoisEenetEeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.eenet.ee/status_available.txt"
        host         = "whois.eenet.ee"
