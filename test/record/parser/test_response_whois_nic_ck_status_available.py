...
#
#   spec/fixtures/responses/whois.nic.ck/status_available
#
...
class TestWhoisNicCkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ck/status_available.txt"
        host         = "whois.nic.ck"
