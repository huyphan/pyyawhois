...
#
#   spec/fixtures/responses/whois.za.net/status_available
#
...
class TestWhoisZaNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.za.net/status_available.txt"
        host         = "whois.za.net"
