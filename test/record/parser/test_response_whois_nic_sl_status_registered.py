...
#
#   spec/fixtures/responses/whois.nic.sl/status_registered
#
...
class TestWhoisNicSlStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.sl/status_registered.txt"
        host         = "whois.nic.sl"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2008-05-18'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2011-05-18'))
