...
#
#   spec/fixtures/responses/whois.nic.net.ng/status_available
#
...
class TestWhoisNicNetNgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.net.ng/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ng")
