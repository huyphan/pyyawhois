...
#
#   spec/fixtures/responses/whois.nic.gd/status_available
#
...
class TestWhoisNicGdStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.gd/status_available.txt"
        host         = "whois.nic.gd"
