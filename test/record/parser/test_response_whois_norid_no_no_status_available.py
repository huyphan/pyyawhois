...
#
#   spec/fixtures/responses/whois.norid.no/no/status_available
#
...
class TestWhoisNoridNoNoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.norid.no/no/status_available.txt"
        host         = "whois.norid.no"
