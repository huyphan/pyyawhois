...
#
#   spec/fixtures/responses/whois.nic.af/status_available
#
...
class TestWhoisNicAfStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.af/status_available.txt"
        host         = "whois.nic.af"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.af")
