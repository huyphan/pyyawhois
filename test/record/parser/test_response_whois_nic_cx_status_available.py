...
#
#   spec/fixtures/responses/whois.nic.cx/status_available
#
...
class TestWhoisNicCxStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.cx/status_available.txt"
        host         = "whois.nic.cx"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.cx")
