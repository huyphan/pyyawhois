...
#
#   spec/fixtures/responses/whois.nic.fo/status_available
#
...
class TestWhoisNicFoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fo/status_available.txt"
        host         = "whois.nic.fo"
