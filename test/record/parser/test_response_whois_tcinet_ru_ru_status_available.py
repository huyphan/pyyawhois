...
#
#   spec/fixtures/responses/whois.tcinet.ru/ru/status_available
#
...
class TestWhoisTcinetRuRuStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tcinet.ru/ru/status_available.txt"
