...
#
#   spec/fixtures/responses/whois.nic.es/status_available
#
...
class TestWhoisNicEsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.es/status_available.txt"
        host         = "whois.nic.es"
