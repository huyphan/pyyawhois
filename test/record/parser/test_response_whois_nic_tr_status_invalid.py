...
#
#   spec/fixtures/responses/whois.nic.tr/status_invalid
#
...
class TestWhoisNicTrStatusInvalid(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.tr/status_invalid.txt"
        host         = "whois.nic.tr"
