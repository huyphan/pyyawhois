...
#
#   spec/fixtures/responses/whois.dot.cf/status_available
#
...
class TestWhoisDotCfStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dot.cf/status_available.txt"
        host         = "whois.dot.cf"
