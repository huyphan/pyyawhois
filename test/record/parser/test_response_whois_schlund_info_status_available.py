...
#
#   spec/fixtures/responses/whois.schlund.info/status_available
#
...
class TestWhoisSchlundInfoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.schlund.info/status_available.txt"
