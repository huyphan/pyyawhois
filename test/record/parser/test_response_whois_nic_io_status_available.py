...
#
#   spec/fixtures/responses/whois.nic.io/status_available
#
...
class TestWhoisNicIoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.io/status_available.txt"
        host         = "whois.nic.io"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.io")
