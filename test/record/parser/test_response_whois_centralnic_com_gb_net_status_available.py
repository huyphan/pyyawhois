...
#
#   spec/fixtures/responses/whois.centralnic.com/gb.net/status_available
#
...
class TestWhoisCentralnicComGbNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.centralnic.com/gb.net/status_available.txt"
