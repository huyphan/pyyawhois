...
#
#   spec/fixtures/responses/whois.afilias-grs.info/lc/status_available
#
...
class TestWhoisAfiliasGrsInfoLcStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.afilias-grs.info/lc/status_available.txt"
