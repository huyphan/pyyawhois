...
#
#   spec/fixtures/responses/whois.nic.pr/status_registered
#
...
class TestWhoisNicPrStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.pr/status_registered.txt"
        host         = "whois.nic.pr"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.pr")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2005-09-15'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-09-15'))
