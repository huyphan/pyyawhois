...
#
#   spec/fixtures/responses/kero.yachay.pe/status_registered
#
...
class TestKeroYachayPeStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/kero.yachay.pe/status_registered.txt"
        host         = "kero.yachay.pe"
