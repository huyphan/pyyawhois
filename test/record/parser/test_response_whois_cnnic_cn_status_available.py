...
#
#   spec/fixtures/responses/whois.cnnic.cn/status_available
#
...
class TestWhoisCnnicCnStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.cnnic.cn/status_available.txt"
        host         = "whois.cnnic.cn"
