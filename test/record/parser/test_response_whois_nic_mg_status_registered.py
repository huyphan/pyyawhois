...
#
#   spec/fixtures/responses/whois.nic.mg/status_registered
#
...
class TestWhoisNicMgStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.mg/status_registered.txt"
        host         = "whois.nic.mg"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.mg")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2009-06-18 08:38:20 UTC'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-10-29 15:13:49 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "1915-nicmg")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2014-11-26 21:00:00 UTC'))
