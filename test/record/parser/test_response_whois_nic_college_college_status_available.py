...
#
#   spec/fixtures/responses/whois.nic.college/college/status_available
#
...
class TestWhoisNicCollegeCollegeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.college/college/status_available.txt"
