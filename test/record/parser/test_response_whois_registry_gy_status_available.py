...
#
#   spec/fixtures/responses/whois.registry.gy/status_available
#
...
class TestWhoisRegistryGyStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registry.gy/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.gy")
