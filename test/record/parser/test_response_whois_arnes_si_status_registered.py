...
#
#   spec/fixtures/responses/whois.arnes.si/status_registered
#
...
class TestWhoisArnesSiStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.arnes.si/status_registered.txt"
        host         = "whois.arnes.si"
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-07-19'))
