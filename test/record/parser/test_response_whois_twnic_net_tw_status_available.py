...
#
#   spec/fixtures/responses/whois.twnic.net.tw/status_available
#
...
class TestWhoisTwnicNetTwStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.twnic.net.tw/status_available.txt"
