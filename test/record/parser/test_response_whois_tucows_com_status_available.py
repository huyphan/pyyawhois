...
#
#   spec/fixtures/responses/whois.tucows.com/status_available
#
...
class TestWhoisTucowsComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tucows.com/status_available.txt"
