...
#
#   spec/fixtures/responses/whois.nic.xxx/status_available
#
...
class TestWhoisNicXxxStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.xxx/status_available.txt"
        host         = "whois.nic.xxx"
