...
#
#   spec/fixtures/responses/whois.nic.org.uy/status_available
#
...
class TestWhoisNicOrgUyStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.org.uy/status_available.txt"
