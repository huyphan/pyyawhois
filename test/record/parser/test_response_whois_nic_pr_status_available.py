...
#
#   spec/fixtures/responses/whois.nic.pr/status_available
#
...
class TestWhoisNicPrStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.pr/status_available.txt"
        host         = "whois.nic.pr"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.pr")
