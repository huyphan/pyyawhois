...
#
#   spec/fixtures/responses/whois.cmc.iq/status_available
#
...
class TestWhoisCmcIqStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.cmc.iq/status_available.txt"
        host         = "whois.cmc.iq"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.iq")
