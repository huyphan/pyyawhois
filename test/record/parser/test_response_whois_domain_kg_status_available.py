...
#
#   spec/fixtures/responses/whois.domain.kg/status_available
#
...
class TestWhoisDomainKgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.domain.kg/status_available.txt"
