...
#
#   spec/fixtures/responses/whois.registrypro.pro/status_registered
#
...
class TestWhoisRegistryproProStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registrypro.pro/status_registered.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.pro")
    ...
    def test_admin_contacts(self):
        ...
        eq_(self.record.admin_contacts[0].id, "google")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2008-07-22 00:00:00 UTC'))

    def test_registrar(self):
        eq_(self.record.registrar.__class__.__name__, 'Registrar')
        eq_(self.record.registrar.id, "R2341-PRO")
    ...
    def test_registrant_contacts(self):
        ...
        eq_(self.record.registrant_contacts[0].id, "google")
    ...
    def test_technical_contacts(self):
        ...
        eq_(self.record.technical_contacts[0].id, "google")
