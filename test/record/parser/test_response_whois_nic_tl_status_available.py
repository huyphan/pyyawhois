...
#
#   spec/fixtures/responses/whois.nic.tl/status_available
#
...
class TestWhoisNicTlStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.tl/status_available.txt"
        host         = "whois.nic.tl"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.tl")
