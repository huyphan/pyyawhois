...
#
#   spec/fixtures/responses/whois.nic.ch/status_available
#
...
class TestWhoisNicChStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ch/status_available.txt"
        host         = "whois.nic.ch"
