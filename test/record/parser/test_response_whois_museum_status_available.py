...
#
#   spec/fixtures/responses/whois.museum/status_available
#
...
class TestWhoisMuseumStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.museum/status_available.txt"
        host         = "whois.museum"
