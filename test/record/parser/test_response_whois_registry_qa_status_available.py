...
#
#   spec/fixtures/responses/whois.registry.qa/status_available
#
...
class TestWhoisRegistryQaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registry.qa/status_available.txt"
