...
#
#   spec/fixtures/responses/whois.yoursrs.com/status_available
#
...
class TestWhoisYoursrsComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.yoursrs.com/status_available.txt"
