...
#
#   spec/fixtures/responses/whois.nic.it/status_available
#
...
class TestWhoisNicItStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.it/status_available.txt"
        host         = "whois.nic.it"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.it")
