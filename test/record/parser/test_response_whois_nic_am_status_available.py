...
#
#   spec/fixtures/responses/whois.nic.am/status_available
#
...
class TestWhoisNicAmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.am/status_available.txt"
        host         = "whois.nic.am"
