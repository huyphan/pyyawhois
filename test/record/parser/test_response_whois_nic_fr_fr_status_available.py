...
#
#   spec/fixtures/responses/whois.nic.fr/fr/status_available
#
...
class TestWhoisNicFrFrStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/fr/status_available.txt"
        host         = "whois.nic.fr"
