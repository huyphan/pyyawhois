...
#
#   spec/fixtures/responses/whois.afilias.info/status_registered
#
...
class TestWhoisAfiliasInfoStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.afilias.info/status_registered.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.info")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2001-07-31 23:57:50 UTC'))

    def test_registrar(self):
        eq_(self.record.registrar.__class__.__name__, 'Registrar')
        eq_(self.record.registrar.id, "R151-LRMS")
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-06-29 09:26:18 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "D37288-LRMS")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2014-07-31 23:57:50 UTC'))

    def test_disclaimer(self):
        eq_(self.record.disclaimer, "Access to AFILIAS WHOIS information is provided to assist persons in determining the contents of a domain name registration record in the Afilias registry database. The data in this record is provided by Afilias Limited for informational purposes only, and Afilias does not guarantee its accuracy.  This service is intended only for query-based access. You agree that you will use this data only for lawful purposes and that, under no circumstances will you use this data to(a) allow, enable, or otherwise support the transmission by e-mail, telephone, or facsimile of mass unsolicited, commercial advertising or solicitations to entities other than the data recipient's own existing customers; or (b) enable high volume, automated, electronic processes that send queries or data to the systems of Registry Operator, a Registrar, or Afilias except as reasonably necessary to register domain names or modify existing registrations. All rights reserved. Afilias reserves the right to modify these terms at any time. By submitting this query, you agree to abide by this policy.")
