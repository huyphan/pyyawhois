...
#
#   spec/fixtures/responses/whois.ascio.com/status_available
#
...
class TestWhoisAscioComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.ascio.com/status_available.txt"
