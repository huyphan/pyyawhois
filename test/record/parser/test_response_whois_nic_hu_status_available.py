...
#
#   spec/fixtures/responses/whois.nic.hu/status_available
#
...
class TestWhoisNicHuStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.hu/status_available.txt"
        host         = "whois.nic.hu"
