...
#
#   spec/fixtures/responses/whois.nic.gov/status_registered
#
...
class TestWhoisNicGovStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.gov/status_registered.txt"
        host         = "whois.nic.gov"
