...
#
#   spec/fixtures/responses/whois.udag.net/status_available
#
...
class TestWhoisUdagNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.udag.net/status_available.txt"
        host         = "whois.udag.net"
