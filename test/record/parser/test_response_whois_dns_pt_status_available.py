...
#
#   spec/fixtures/responses/whois.dns.pt/status_available
#
...
class TestWhoisDnsPtStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dns.pt/status_available.txt"
        host         = "whois.dns.pt"
