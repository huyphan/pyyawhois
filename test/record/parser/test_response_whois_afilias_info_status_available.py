...
#
#   spec/fixtures/responses/whois.afilias.info/status_available
#
...
class TestWhoisAfiliasInfoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.afilias.info/status_available.txt"
