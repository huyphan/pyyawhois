...
#
#   spec/fixtures/responses/whois.registry.gy/status_registered
#
...
class TestWhoisRegistryGyStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registry.gy/status_registered.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.gy")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2008-05-12 17:56:23 UTC'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2014-01-16 06:53:13 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "573328-CoCCA")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2014-10-04 23:30:00 UTC'))
