...
#
#   spec/fixtures/responses/whois.sgnic.sg/status_available
#
...
class TestWhoisSgnicSgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.sgnic.sg/status_available.txt"
        host         = "whois.sgnic.sg"
