...
#
#   spec/fixtures/responses/whois.nic.priv.at/status_registered
#
...
class TestWhoisNicPrivAtStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.priv.at/status_registered.txt"
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2002-10-13'))
