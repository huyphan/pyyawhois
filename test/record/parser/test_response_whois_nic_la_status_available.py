...
#
#   spec/fixtures/responses/whois.nic.la/status_available
#
...
class TestWhoisNicLaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.la/status_available.txt"
        host         = "whois.nic.la"
