...
#
#   spec/fixtures/responses/whois.arnes.si/status_available
#
...
class TestWhoisArnesSiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.arnes.si/status_available.txt"
        host         = "whois.arnes.si"
