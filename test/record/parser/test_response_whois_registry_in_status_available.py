...
#
#   spec/fixtures/responses/whois.registry.in/status_available
#
...
class TestWhoisRegistryInStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registry.in/status_available.txt"
