...
#
#   spec/fixtures/responses/whois1.nic.bi/status_available
#
...
class TestWhois1NicBiStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois1.nic.bi/status_available.txt"
        host         = "whois1.nic.bi"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.bi")
