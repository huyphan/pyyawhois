...
#
#   spec/fixtures/responses/whois.nic.fr/re/status_available
#
...
class TestWhoisNicFrReStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/re/status_available.txt"
        host         = "whois.nic.fr"
