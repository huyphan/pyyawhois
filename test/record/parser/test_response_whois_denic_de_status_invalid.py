...
#
#   spec/fixtures/responses/whois.denic.de/status_invalid
#
...
class TestWhoisDenicDeStatusInvalid(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.denic.de/status_invalid.txt"
        host         = "whois.denic.de"
    ...
    def test_domain(self):
        eq_(self.record.domain, "googlededewdedewdewde.foo.de")
