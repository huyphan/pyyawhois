...
#
#   spec/fixtures/responses/whois.eu.org/status_available
#
...
class TestWhoisEuOrgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.eu.org/status_available.txt"
        host         = "whois.eu.org"
