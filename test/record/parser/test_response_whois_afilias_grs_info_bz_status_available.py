...
#
#   spec/fixtures/responses/whois.afilias-grs.info/bz/status_available
#
...
class TestWhoisAfiliasGrsInfoBzStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.afilias-grs.info/bz/status_available.txt"
