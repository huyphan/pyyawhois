...
#
#   spec/fixtures/responses/whois.jprs.jp/jp/status_available
#
...
class TestWhoisJprsJpJpStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.jprs.jp/jp/status_available.txt"
        host         = "whois.jprs.jp"
