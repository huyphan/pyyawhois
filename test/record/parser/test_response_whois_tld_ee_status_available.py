...
#
#   spec/fixtures/responses/whois.tld.ee/status_available
#
...
class TestWhoisTldEeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.tld.ee/status_available.txt"
        host         = "whois.tld.ee"
