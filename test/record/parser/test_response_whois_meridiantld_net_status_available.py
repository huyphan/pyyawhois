...
#
#   spec/fixtures/responses/whois.meridiantld.net/status_available
#
...
class TestWhoisMeridiantldNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.meridiantld.net/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.tc")
