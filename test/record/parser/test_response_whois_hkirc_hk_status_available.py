...
#
#   spec/fixtures/responses/whois.hkirc.hk/status_available
#
...
class TestWhoisHkircHkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.hkirc.hk/status_available.txt"
        host         = "whois.hkirc.hk"
