...
#
#   spec/fixtures/responses/whois.nic.im/status_registered
#
...
class TestWhoisNicImStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.im/status_registered.txt"
        host         = "whois.nic.im"
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-08-03 23:59:52'))
