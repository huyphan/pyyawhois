...
#
#   spec/fixtures/responses/whois.dotpostregistry.net/status_available
#
...
class TestWhoisDotpostregistryNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dotpostregistry.net/status_available.txt"
