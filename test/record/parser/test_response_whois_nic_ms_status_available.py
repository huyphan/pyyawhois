...
#
#   spec/fixtures/responses/whois.nic.ms/status_available
#
...
class TestWhoisNicMsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ms/status_available.txt"
        host         = "whois.nic.ms"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ms")
