...
#
#   spec/fixtures/responses/whois.nic.tc/tc/status_registered
#
...
class TestWhoisNicTcTcStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.tc/tc/status_registered.txt"
        host         = "whois.nic.tc"
