...
#
#   spec/fixtures/responses/whois.nic.lk/lk/status_registered
#
...
class TestWhoisNicLkLkStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.lk/lk/status_registered.txt"
        host         = "whois.nic.lk"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.lk")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-04-01'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-03-09'))
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-04-01'))
