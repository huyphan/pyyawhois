...
#
#   spec/fixtures/responses/whois.dk-hostmaster.dk/status_available
#
...
class TestWhoisDkHostmasterDkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dk-hostmaster.dk/status_available.txt"
