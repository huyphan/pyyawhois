...
#
#   spec/fixtures/responses/whois.jprs.jp/ne.jp/status_registered
#
...
class TestWhoisJprsJpNeJpStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.jprs.jp/ne.jp/status_registered.txt"
        host         = "whois.jprs.jp"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-09-11'))
