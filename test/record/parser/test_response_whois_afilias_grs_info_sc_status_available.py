...
#
#   spec/fixtures/responses/whois.afilias-grs.info/sc/status_available
#
...
class TestWhoisAfiliasGrsInfoScStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.afilias-grs.info/sc/status_available.txt"
