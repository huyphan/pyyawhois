...
#
#   spec/fixtures/responses/whois.nic.ki/status_registered
#
...
class TestWhoisNicKiStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ki/status_registered.txt"
        host         = "whois.nic.ki"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.ki")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2006-05-15 12:00:00 UTC'))
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-12-06 07:34:23 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "18030-CoCCA")
