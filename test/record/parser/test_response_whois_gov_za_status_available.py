...
#
#   spec/fixtures/responses/whois.gov.za/status_available
#
...
class TestWhoisGovZaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.gov.za/status_available.txt"
        host         = "whois.gov.za"
