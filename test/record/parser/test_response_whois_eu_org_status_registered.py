...
#
#   spec/fixtures/responses/whois.eu.org/status_registered
#
...
class TestWhoisEuOrgStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.eu.org/status_registered.txt"
        host         = "whois.eu.org"
