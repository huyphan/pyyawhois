...
#
#   spec/fixtures/responses/whois.nic.ac/status_available
#
...
class TestWhoisNicAcStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ac/status_available.txt"
        host         = "whois.nic.ac"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ac")
