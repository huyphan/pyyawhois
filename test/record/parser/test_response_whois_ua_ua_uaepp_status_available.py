...
#
#   spec/fixtures/responses/whois.ua/ua/uaepp/status_available
#
...
class TestWhoisUaUaUaeppStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.ua/ua/uaepp/status_available.txt"
        host         = "whois.ua"
