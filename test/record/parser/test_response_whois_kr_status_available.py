...
#
#   spec/fixtures/responses/whois.kr/status_available
#
...
class TestWhoisKrStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.kr/status_available.txt"
        host         = "whois.kr"
