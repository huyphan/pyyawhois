...
#
#   spec/fixtures/responses/whois.nic.sn/status_available
#
...
class TestWhoisNicSnStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.sn/status_available.txt"
        host         = "whois.nic.sn"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.sn")
