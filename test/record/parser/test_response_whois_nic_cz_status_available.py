...
#
#   spec/fixtures/responses/whois.nic.cz/status_available
#
...
class TestWhoisNicCzStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.cz/status_available.txt"
        host         = "whois.nic.cz"
