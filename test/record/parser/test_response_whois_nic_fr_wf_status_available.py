...
#
#   spec/fixtures/responses/whois.nic.fr/wf/status_available
#
...
class TestWhoisNicFrWfStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/wf/status_available.txt"
        host         = "whois.nic.fr"
