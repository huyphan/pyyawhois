...
#
#   spec/fixtures/responses/whois.bnnic.bn/bn/status_available
#
...
class TestWhoisBnnicBnBnStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.bnnic.bn/bn/status_available.txt"
        host         = "whois.bnnic.bn"
