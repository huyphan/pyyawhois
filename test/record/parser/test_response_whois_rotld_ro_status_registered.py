...
#
#   spec/fixtures/responses/whois.rotld.ro/status_registered
#
...
class TestWhoisRotldRoStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.rotld.ro/status_registered.txt"
        host         = "whois.rotld.ro"
