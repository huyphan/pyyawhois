...
#
#   spec/fixtures/responses/whois.nic.name/status_available
#
...
class TestWhoisNicNameStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.name/status_available.txt"
        host         = "whois.nic.name"
