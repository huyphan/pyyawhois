...
#
#   spec/fixtures/responses/whois.register.bg/status_available
#
...
class TestWhoisRegisterBgStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.register.bg/status_available.txt"
