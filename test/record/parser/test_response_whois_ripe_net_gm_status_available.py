...
#
#   spec/fixtures/responses/whois.ripe.net/gm/status_available
#
...
class TestWhoisRipeNetGmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.ripe.net/gm/status_available.txt"
        host         = "whois.ripe.net"
