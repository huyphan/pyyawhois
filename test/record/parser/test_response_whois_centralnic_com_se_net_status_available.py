...
#
#   spec/fixtures/responses/whois.centralnic.com/se.net/status_available
#
...
class TestWhoisCentralnicComSeNetStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.centralnic.com/se.net/status_available.txt"
