...
#
#   spec/fixtures/responses/whois.nic.ag/status_registered
#
...
class TestWhoisNicAgStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ag/status_registered.txt"
        host         = "whois.nic.ag"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.ag")
    ...
    def test_admin_contacts(self):
        ...
        eq_(self.record.admin_contacts[0].id, "AGRS-129819")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-01-05 14:06:59 UTC'))
    ...
    def test_technical_contacts(self):
        ...
        eq_(self.record.technical_contacts[0].id, "AGRS-129819")
    ...
    def test_updated_on(self):
        ...
        eq_(self.record.updated_on, time_parse('2013-12-04 10:20:49 UTC'))

    def test_domain_id(self):
        eq_(self.record.domain_id, "D48552-LRCC")

    def test_expires_on(self):
        eq_(self.record.expires_on.__class__.__name__, 'datetime')
        eq_(self.record.expires_on, time_parse('2015-01-05 14:06:59 UTC'))
