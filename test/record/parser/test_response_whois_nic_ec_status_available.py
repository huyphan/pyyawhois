...
#
#   spec/fixtures/responses/whois.nic.ec/status_available
#
...
class TestWhoisNicEcStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.ec/status_available.txt"
        host         = "whois.nic.ec"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.ec")
