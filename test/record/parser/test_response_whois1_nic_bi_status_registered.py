...
#
#   spec/fixtures/responses/whois1.nic.bi/status_registered
#
...
class TestWhois1NicBiStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois1.nic.bi/status_registered.txt"
        host         = "whois1.nic.bi"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.bi")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2002-09-29 22:00:00 UTC'))

    def test_registrar(self):
        eq_(self.record.registrar.__class__.__name__, 'Registrar')
        eq_(self.record.registrar.id, None)
        eq_(self.record.registrar.name, "MarkMonito")
    ...
    def test_expires_on(self):
        ...
        eq_(self.record.expires_on, time_parse('2014-09-29 22:00:00 UTC'))
