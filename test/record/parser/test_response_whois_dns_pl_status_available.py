...
#
#   spec/fixtures/responses/whois.dns.pl/status_available
#
...
class TestWhoisDnsPlStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dns.pl/status_available.txt"
        host         = "whois.dns.pl"
