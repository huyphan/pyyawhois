...
#
#   spec/fixtures/responses/whois.website.ws/status_available
#
...
class TestWhoisWebsiteWsStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.website.ws/status_available.txt"
