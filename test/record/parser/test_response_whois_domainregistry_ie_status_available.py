...
#
#   spec/fixtures/responses/whois.domainregistry.ie/status_available
#
...
class TestWhoisDomainregistryIeStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.domainregistry.ie/status_available.txt"
