...
#
#   spec/fixtures/responses/whois.ati.tn/status_available
#
...
class TestWhoisAtiTnStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.ati.tn/status_available.txt"
        host         = "whois.ati.tn"
