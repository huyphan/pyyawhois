...
#
#   spec/fixtures/responses/whois.ja.net/ac.uk/status_available
#
...
class TestWhoisJaNetAcUkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.ja.net/ac.uk/status_available.txt"
        host         = "whois.ja.net"
