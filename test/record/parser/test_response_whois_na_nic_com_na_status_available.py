...
class TestWhoisNaNicComNaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.na-nic.com.na/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.na")
