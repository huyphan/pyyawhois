...
#
#   spec/fixtures/responses/whois.nic.so/status_available
#
...
class TestWhoisNicSoStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.so/status_available.txt"
        host         = "whois.nic.so"
