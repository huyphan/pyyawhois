...
#
#   spec/fixtures/responses/whois.bn/status_available
#
...
class TestWhoisBnStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.bn/status_available.txt"
        host         = "whois.bn"
