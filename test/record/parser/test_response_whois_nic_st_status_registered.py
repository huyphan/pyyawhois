...
#
#   spec/fixtures/responses/whois.nic.st/status_registered
#
...
class TestWhoisNicStStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.st/status_registered.txt"
        host         = "whois.nic.st"
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2004-06-15'))

    def test_updated_on(self):
        eq_(self.record.updated_on.__class__.__name__, 'datetime')
        eq_(self.record.updated_on, time_parse('2009-05-18'))
