...
#
#   spec/fixtures/responses/whois.nic.fr/wf/status_registered
#
...
class TestWhoisNicFrWfStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.fr/wf/status_registered.txt"
        host         = "whois.nic.fr"
    ...
    def test_registrant_contacts(self):
        ...
        eq_(self.record.registrant_contacts[0].id, "AEFT2-FRNIC")
        eq_(self.record.registrant_contacts[0].name, None)
        eq_(self.record.registrant_contacts[0].organization, "Afnic (Wallis et Futuna - TOM)")
