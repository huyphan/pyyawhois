...
#
#   spec/fixtures/responses/whois.ja.net/gov.uk/status_available
#
...
class TestWhoisJaNetGovUkStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.ja.net/gov.uk/status_available.txt"
        host         = "whois.ja.net"
