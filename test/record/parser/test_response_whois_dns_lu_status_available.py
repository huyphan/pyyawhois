...
#
#   spec/fixtures/responses/whois.dns.lu/status_available
#
...
class TestWhoisDnsLuStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.dns.lu/status_available.txt"
        host         = "whois.dns.lu"
