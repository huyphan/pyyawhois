...
#
#   spec/fixtures/responses/whois.nic.dm/status_available
#
...
class TestWhoisNicDmStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.dm/status_available.txt"
        host         = "whois.nic.dm"
