...
#
#   spec/fixtures/responses/whois.gg/status_registered
#
...
class TestWhoisGgStatusRegistered(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.gg/status_registered.txt"
        host         = "whois.gg"
    ...
    def test_domain(self):
        eq_(self.record.domain, "google.gg")
    ...
    def test_created_on(self):
        ...
        eq_(self.record.created_on, time_parse('2003-04-30 00:00:00 UTC'))

    def test_updated_on(self):
        eq_(self.record.updated_on, None)

    def test_domain_id(self):
        eq_(self.record.domain_id, "24221-CI")
