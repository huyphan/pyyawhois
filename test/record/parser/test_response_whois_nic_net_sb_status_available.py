...
#
#   spec/fixtures/responses/whois.nic.net.sb/status_available
#
...
class TestWhoisNicNetSbStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.nic.net.sb/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.sb")
