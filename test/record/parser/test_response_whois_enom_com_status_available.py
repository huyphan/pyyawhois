...
#
#   spec/fixtures/responses/whois.enom.com/status_available
#
...
class TestWhoisEnomComStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.enom.com/status_available.txt"
        host         = "whois.enom.com"
