...
#
#   spec/fixtures/responses/whois.srs.net.nz/status_available
#
...
class TestWhoisSrsNetNzStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.srs.net.nz/status_available.txt"
    ...
    def test_domain(self):
        eq_(self.record.domain, "u34jedzcq.co.nz")
