...
#
#   spec/fixtures/responses/whois.registry.net.za/status_available
#
...
class TestWhoisRegistryNetZaStatusAvailable(object):

    def setUp(self):
        fixture_path = "spec/fixtures/responses/whois.registry.net.za/status_available.txt"
